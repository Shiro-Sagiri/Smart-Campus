import { listMyCourseByPage, unselectCourse } from '@/services/smart-campus/courseController';
    ...
    },
    {
      ...
      render: (_, record) => [
        <Popconfirm
          ...
          onConfirm={async () => {
            try {
              await unselectCourse({
                courseId: record.courseId as number,
  ...
  return (
    <ProTable<API.Course, API.CourseQueryRequest>
      ...
      request={async (
        ...
        // 如果需要转化参数可以在这里进行修改
        const msg = await listMyCourseByPage({
